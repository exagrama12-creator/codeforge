...
var FORGE_AGENTS = [
  {
    ...
    name: 'FORGE',
    icon: '⚡',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=forge&backgroundColor=10b981',
    color: '#10b981',
  ...
  },
  {
    ...
    name: 'Luna',
    icon: '🎨',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=luna&backgroundColor=818cf8&hair=long',
    color: '#818cf8',
  ...
  },
  {
    ...
    name: 'Thor',
    icon: '🔧',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=thor&backgroundColor=f59e0b',
    color: '#f59e0b',
  ...
  },
  {
    ...
    name: 'Pixel',
    icon: '📱',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=pixel&backgroundColor=0ea5e9',
    color: '#0ea5e9',
  ...
  },
  {
    ...
    name: 'Atlas',
    icon: '🛡️',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=atlas&backgroundColor=ef4444',
    color: '#ef4444',
  ...
  },
  {
    ...
    name: 'Sage',
    icon: '📊',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=sage&backgroundColor=8b5cf6&hair=long',
    color: '#8b5cf6',
  ...
  },
  {
    ...
    name: 'Phoenix',
    icon: '🔥',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=phoenix&backgroundColor=f97316',
    color: '#f97316',
  ...
  },
  {
    ...
    name: 'Iris',
    icon: '📝',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=iris&backgroundColor=ec4899&hair=long',
    color: '#ec4899',
  ...
  },
  {
    ...
    name: 'Hawk',
    icon: '🔍',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=hawk&backgroundColor=14b8a6',
    color: '#14b8a6',
    role: 'Debugger & QA',
  ...
  },
  {
    ...
    name: 'Nova',
    icon: '✨',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=nova&backgroundColor=f472b6&hair=long',
    color: '#f472b6',
    role: 'UI/UX Designer',
  ...
  },
  {
    ...
    name: 'Zeus',
    icon: '💰',
    avatar: 'https://api.dicebear.com/7.x/personas/svg?seed=zeus&backgroundColor=fbbf24',
    color: '#fbbf24',
    role: 'Controlador Financeiro',
    desc: 'Super agente financeiro. Gerencia cobranças, planos, faturas, assinaturas, cupons e relatórios financeiros.',
    skills: ['Cobranças', 'Planos', 'Faturas', 'Assinaturas', 'Relatórios', 'Cupons']
  }
];
